...
{
    public class CartaPorteWMSController : Controller
    {
        string mode = "PRO";
    ...
    [ApiController]
    [Route("api")]
    public class CartaPorteWMSApiController : ControllerBase
    {
        string mode = "PRO";
        ...
        public async Task<IActionResult> GetScnByCono(string precon)
        {
            try
            {
                var result = await BL.CartaPorteWMS.CartaPorteWMS.GetScnByCono(precon, mode);
        ...
        public async Task<IActionResult> GetOperadores()
        {
            try
            {
                var result = await BL.CartaPorteWMS.CartaPorteWMS.GetOperadores(mode);
        ...
        public async Task<IActionResult> GetUnidades()
        {
            try
            {
                var result = await BL.CartaPorteWMS.CartaPorteWMS.GetUnidades(mode);
        ...
        public async Task<IActionResult> EnviarCarta([FromBody] EnviarCartaRequest request)
        {
            try
            {
                ...
                var result = await BL.CartaPorteWMS.CartaPorteWMS.EnviarCarta(request, mode);
