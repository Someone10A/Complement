...
namespace DL
{
    public class ApiOracle
    {
        ...
        public static string GetInfoWMSPro(string orderNumber)
        {
            return $"https://e6.wms.ocs.oraclecloud.com/sears2/wms/lgfapi/v10/entity/order_hdr?company_id__code=GPOSAN&facility_id__code=VAL&order_nbr={orderNumber}&values_list=order_nbr:OrderNumber,status_id:IdEstatus,stop_ship_flg:EnvioBloqueado";
        }
        public static string GetInfoWMSDev(string orderNumber)
        {
            return $"https://te6.wms.ocs.oraclecloud.com/sears2_test/wms/lgfapi/v10/entity/order_hdr?company_id__code=GPOSAN&facility_id__code=VAL&order_nbr={orderNumber}&values_list=order_nbr:OrderNumber,status_id:IdEstatus,stop_ship_flg:EnvioBloqueado";
        }
    }
}
