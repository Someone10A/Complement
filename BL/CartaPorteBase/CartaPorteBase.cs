...
namespace BL.CartaPorteBase
{
    public static class CartaPorteBase
    {
        ...
        public static async Task InsertarMercancia(Dictionary<string, object> codigoFiscal, string idOri, string idDes, 
        ...
        public static async Task InsertarOperador(Dictionary<string, object> operadorInfo, string nombreOperador, 
            string idUni, int codEmp, string mode)
        {
            using (var connection = new OdbcConnection(DL.Connection.GetConnectionStringGnx(mode)))
            {
        ...
        public static async Task GenerarCSVsDespuesInserts(ML.CartaPorteLga.EnviarCartaRequest request, string idUni, int codEmp, string mode)
        {
            try
            {
