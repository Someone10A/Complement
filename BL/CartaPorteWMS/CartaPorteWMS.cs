...
namespace BL.CartaPorteWMS
{
    public class CartaPorteWMS
    {
        ...
        {
            return await CartaPorteBase.CartaPorteBase.GetOperadores(mode);
        }
        ...
        public static async Task<ML.Result> EnviarCarta(ML.CartaPorteLga.EnviarCartaRequest request, string mode)
        {
            ML.Result result = new ML.Result();
            try
            {
        ...
        private static async Task<ML.Result> ValidarDomicilios(List<Dictionary<string, object>> domicilios, string mode)
        {
            ...
            foreach (var domicilio in domicilios)
            {
                ...
                if (existeEstado != null)
                {
                    ...
                    var codigosLocalidad = await CartaPorteBase.CartaPorteBase.GetLocalidad(edoEntFed, mode);
